...
modelling purposes [[1]](#crestr). The probabilitic proxy-climate responses can be used to quantivatively reconstruct climate from their statistical combination
[[2](#ChevalierLimpopo)-[3](#cc15)], or, alternatively, they can be used in a
