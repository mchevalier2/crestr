...
#' recons <- crest(taxa.name=colnames(crest_ex)[-1], df=crest_ex, pse=crest_ex_pse, taxaType = 0,
...
crest <- function ( taxa.name, pse, taxaType, climate, df,
    ...
    x = crest.get_distributions( taxa.name = taxa.name, pse = pse, taxaType = taxaType, climate = climate,
