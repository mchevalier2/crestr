...
>
> I regularly host **online crestr workshops** where we explore both the theoretical foundations of the method and its practical implementation.
> You’ll learn everything you need to produce your first reconstructions with confidence.
> Check out the upcoming dates on the [DataSharp Academy CREST workshop page](https://datasharpacademy.com/workshop-crest/) and book your seat.
> I also offer [consulting support for CREST analyses](https://datasharpacademy.com/crest-consulting/) if you need more personalised guidance.
>
> Feel free to get in touch at [manuel.chevalier@datasharpacademy.com](manuel.chevalier@datasharpacademy.com).
