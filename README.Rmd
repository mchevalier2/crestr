...
additional functionalities to incorporate to the package, you can contact me at
...
These pseudo data can be provide to the \code{crest} function and provided some
...
If satisfying, the results can be directly exported from the R environment in a
