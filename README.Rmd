...
[![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://www.tidyverse.org/lifecycle/)
...
(*i.e.* randomly generated data). A more exhaustive documentation and different
case studies are is available **<https://mchevalier2.github.io/crestr/>**.
...
```{r, out.width="100%", fig.height=6, fig.width=6}
